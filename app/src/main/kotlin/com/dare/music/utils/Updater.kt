...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/t4ulquiorra/Dare-Music"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Dare.apk" -> "universal" to "foss"
                name == "Dare-with-Google-Cast.apk" -> "universal" to "gms"
